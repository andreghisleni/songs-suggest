    ...
    return (
      <main
        ...
        className={cn(
          ...
          'peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(4)))] md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:p-2 md:peer-data-[variant=inset]:peer-data-[state=collapsed]:pl-2 md:peer-data-[variant=inset]:pl-0 md:peer-data-[variant=inset]:shadow-sm',
          'data-[opened=true]:w-[calc(100vw-var(--sidebar-width)-8px)]',
          'data-[opened=true]:ml-2',
          className,
        )}
        data-opened={isMobile ? false : open}
        {...props}
      />
    );
  },
